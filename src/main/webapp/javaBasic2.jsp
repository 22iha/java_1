...
<%
    ...
    // 各平均を入れるための配列
	double[] average = { (double)(aScore[0]+bScore[0])/2,(double)(aScore[1]+bScore[1])/2,(double)(aScore[2]+bScore[2])/2 };
    // 各平均点を計算し、配列へ計算結果を代入
    ...
    // 全点数の合計を求め、変数へ代入
	double sum = average[0]+average[1]+average[2];
    // 合計点数の平均を求めて、変数へ代入
...
<body>
  ...
  <h2>平均点</h2>
  <p>国語：<%out.println(average[0]);%></p>
  <p>数学：<%out.println(average[1]);%></p>
  <p>英語：<%out.println(average[2]);%></p>
